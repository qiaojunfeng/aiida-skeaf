#
# Sphinx configuration for aiida-skeaf
#
...
release = aiida_skeaf.__version__
...
html_title = f"aiida-skeaf v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-skeaf.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_skeaf")
